    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <div>
           ...
           <p style={{color:"#183152", fontFamily:"Helvetica, sans-serif", paddingTop:20, paddingBottom:50}}>Use Waterfront Station to transfer to the Canada Line, SeaBus, or West Coast Express.
              </p>
        </div>
