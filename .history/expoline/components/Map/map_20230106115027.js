...
export default function Map() {
    ...
    return (
        ...
        <MapContainer className={style.map} center={position} zoom={14} scrollWheelZoom={true}>
            ...
            <Marker icon={myIcon} position={[49.2862526257819, -123.1202039]}
            >
                <Popup>
            ...
            <Marker icon={myIcon} position={[49.283438850308286, -123.11621933259502]}
            >
                <Popup>
            ...
            <Marker icon={myIcon} position={[49.28013284319446, -123.11014287862584]}
            >
                <Popup>
            ...
            <Marker icon={myIcon} position={[49.273318980467025, -123.10037145958005]}
            >
                <Popup>
            ...
            <Marker icon={myIcon} position={[49.2627770134397, -123.06919358656506]}
            >
                <Popup>
            ...
            <Marker icon={myIcon} position={[49.24841124748144, -123.055842200058]}
            >
                <Popup>
            ...
            <Marker icon={myIcon} position={[49.24434236679643, -123.04542767492465]}
            >
                <Popup>
            ...
            <Marker icon={myIcon} position={[49.238527289117606, -123.03180071725312]}
            >
                <Popup>
            ...
            <Marker icon={myIcon} position={[49.22992666226876, -123.01272618921564]}
            >
                <Popup>
            ...
            <Marker icon={myIcon} position={[49.22591186740195, -123.00391564608952]}
            >
                <Popup>
            ...
            <Marker icon={myIcon} position={[49.22022674217617, -122.988486726947122, -122.988486726947122]}
            >
                <Popup>
            ...
            <Marker icon={myIcon} position={[49.21276468206421, -122.95933430532412]}
            >
                <Popup>
            ...
            <Marker icon={myIcon} position={[49.2002694713839, -122.94923127907236]}
            >
                <Popup>
            ...
            <Marker icon={myIcon} position={[49.20176121342438, -122.91268977631553]}
            >
                <Popup>
            ...
            <Marker icon={myIcon} position={[49.20521830518485, -122.9060229478834]}
            >
                <Popup>
            ...
            <Marker icon={myIcon} position={[49.20102097877474, -122.8508964126631]} pathOptions={blueOption}>
                <Popup>Gateway Station<br /> | Expo Line |</Popup>
            </Marker>

            <Marker icon={myIcon} position={[49.1897209413475, -122.84797435958329]} pathOptions={blueOption}>
                <Popup>Surrey Central Station<br />| Expo Line |</Popup>
            </Marker>

            <Marker icon={myIcon} position={[49.18290999816236, -122.84478657307581]} pathOptions={blueOption}>
                <Popup>King George Station<br />| Expo Line |</Popup>
            </Marker>

            <Marker icon={myIcon} position={[49.22559946869088, -122.88933206544792]} pathOptions={blueOption}>
                <Popup>Sapperton Station<br />| Expo Line |</Popup>
            </Marker>

            <Marker icon={myIcon} position={[49.23299466100193, -122.88290531725335]} pathOptions={blueOption}>
                <Popup>Braid Station<br />| Expo Line |</Popup>
            </Marker>

            <Marker icon={myIcon} position={[49.248814953016954, -122.89720949397046]} pathOptions={blueOption}>
                <Popup>Lougheed Town Centre Station<br />| Milleniun Line & Expo Line |</Popup>
            </Marker>

            <Marker icon={myIcon} position={[49.25367127330616, -122.9187357167187]} pathOptions={blueOption}>
