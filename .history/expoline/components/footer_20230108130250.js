...
export default function Footer() {
    ...
    return <FooterCont>
        ...
        <div style={{display:"flex", flexDirection:"column"}}>
            ...
            <p style={{color:"#183152", fontFamily:"Helvetica, sans-serif", marginBottom:20, fontWeight:"bold"}}>Call us at 604.953.3333</p>
            <p style={{color:"#183152", fontFamily:"Helvetica, sans-serif", marginBottom:20,fontWeight:"bold"}}>400-287 Nelson's Ct., New Westminster, BC V3L0E7</p>
